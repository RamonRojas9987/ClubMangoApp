...
import org.bedu.clubmangoapp.viewmodel.factory.BaseCategoryViewModelFactory
import javax.inject.Inject
@AndroidEntryPoint
class NecklacesFragment: BaseCategoryFragment() {
    @Inject
    lateinit var firestore: FirebaseFirestore

    val viewModel by viewModels<CategoryViewModel>{
        BaseCategoryViewModelFactory(firestore, Category.Necklaces)
    }
